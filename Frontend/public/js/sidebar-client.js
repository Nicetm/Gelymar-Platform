  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    form?.addEventListener("submit", async e => {
      ...
      try {
        ...
        const profileData = {
          full_name: document.getElementById("clientNameInput").value.trim(),
